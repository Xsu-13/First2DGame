...
public class CorneliusAI : MonoBehaviour
{
    ...
    [Header("Урон")]
    [SerializeField] int lightingDamage = 10;
    ...
    public void AttackPlayer()
    {
        ...
        anim.SetTrigger("attackLighting");
        ...
        foreach (Collider2D player in players)
        {
            ...
            playerH.TakeDamage(lightingDamage);
        }
    }
    ...
    public class State
    {
        ...
        protected CorneliusAI cornelius;
        ...
        public State(GameObject _enemy, Transform _player1, Transform _player2)
        {
            ...
            player2 = _player2;
            stage = EVENT.ENTER;
            cornelius = enemy.GetComponent<CorneliusAI>();
            groundDetection = cornelius.groungDetection;
            waypoints = cornelius.waypoints;
            rb = enemy.GetComponent<Rigidbody2D>();
            anim = cornelius.anim;
            //groundDetection = enemyfsm.groungDetection;
            //castPoint = enemyfsm.castPoint;
            visDist = cornelius.visDist;
            visAttack = cornelius.visAttack;
            walkSpeed = cornelius.walkSpeed;
            runSpeed = cornelius.runSpeed;
    ...
    public class Pursue : State
    {
        ...
        public override void Update()
        {
            ...
            {
                enemy.transform.position += new Vector3(0, runSpeed*Time.deltaTime,0);
    ...
    public class Attack : State
    {
        ...
        public override void Update()
        {
            ...
            if (timer <= 0)
            {
                enemy.GetComponent<CorneliusAI>().AttackPlayer();
                timer = 1.5f;
            }
            ...
            */
            if (CanSeePlayer())
            {
                if (!CanAttackPlayer(player) && cornelius.finishedAttack)
                {
                    nextState = new Pursue(enemy, player1, player2);
                    stage = EVENT.EXIT;
                }
    ...
    public class LightingAttack : State
    {

        public LightingAttack(GameObject _enemy, Transform _player1, Transform _player2) : base(_enemy, _player1, _player2)
        {
            name = STATE.ATTACK;
            timer = 0f;
        }
